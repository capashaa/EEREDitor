    ...
    public partial class MainForm : Form
    {
        ...
        public MainForm()
        {
            ...
            bgInit = new int[,] {
                ...
                //Basic bgs
                { 500,0}, { 501,1}, { 502,2}, { 503,3}, { 504,4}, { 505,5}, { 506,6}, { 644,138 }, {645, 139 },{715,209},
                
                //Brick bgs
                { 507,7}, { 508,8}, { 509,9}, { 510,10}, { 511,11}, { 512,12},{716,210},
                {646,140},{647,141 },{648,142},

                //Beta bgs
                { 743, 237 },{ 744, 238 },{ 745, 239 }, { 746, 240 },{ 747, 241 },
                { 748, 242 },{ 749, 243 },{ 750, 244 },{ 751, 245 },{ 752, 246 },

                //Checker bg
                { 513,13}, { 514,14}, { 515,15}, { 516,16}, { 517,17}, { 518,18}, 
                { 519,19}, { 649, 143}, { 650, 144}, { 718, 212},
                
                //Dark bg
                { 520,20},{ 521,21}, { 522,22}, { 523,23}, { 524,24}, { 525,25}, 
                { 526,26}, {719, 213}, {651,145}, {652, 146},

                //Normal bg
                { 610, 110},{ 611, 111},{ 612, 112},{ 610, 110},{ 613, 113},
                { 614, 114},{ 615, 115},{ 616, 116},{ 653, 147},{ 654, 148},
                {717,211},

                //Canvas bg
                { 533,33}, { 534,34}, { 535,35}, { 536,36}, { 537,37}, 
                { 538,38}, {606,106},{671,165},{672,166},

                //Pastel bg
                { 527,27}, { 528,28}, { 529,29}, { 530,30}, { 531,31}, 
                { 532,32},{676, 170}, {677, 171},{776, 258},{787,272},{777,259},

                //Carnival bg
                { 545,45}, { 546,46}, { 547,47}, { 548,48}, { 549,49}, 
                { 558,58},{ 563,63},{ 607,107},
                ...
                //Stone bg
                { 561,61}, { 562,62},{ 688,182 }, { 689,183 }, { 690,184 }, 
                { 691,185 }, { 692,186 }, { 693,187 },

                //Dojo bg
                { 564,64}, { 565,65}, { 566,66}, { 567,67},  { 667,161}, 
                { 668,162}, { 669,163}, { 670,164},
                ...
                //Medieval bg
                { 599,99}, { 600,100},{ 590,90}, { 591,91}, { 592,92}, {556, 56 },{ 593,93},
                //99, 100, 90, 91, 92, 56, 93
                ...
                //Neon bg
                {605, 105 },{673, 167 },{674, 168 },{675, 169 },{697, 191 },
                {698, 192 },
                ...
                //Jungle bg
                {617, 117 },{618, 118 },{619, 119 },{620, 120 },{621, 121 },
                {622, 122 },{623, 123 },

                //Christmas 2012 bg
                {624, 124 },{625, 125 },{626, 126 },

                //Lava bg
                {627, 127 },{628, 128 },{629, 129 },

                //Swamp bg
                {557, 57 },{630, 130 },

                //Marble bg
                {638, 132 },{639, 133 },{640, 134 },

                //Autumn 2014 bg
                {641, 135 },{642, 136 },{643, 137 },

                //Gold bg
                {709, 198 },{710, 199 },{711, 200 },

                //Cave bg
                {788, 269 },{789, 270 },{790, 271 },{655, 149 },{656, 150 },
                {657, 151 },{658, 152 },{659, 153 },{660, 154 },{661, 155 },
                {662, 156 },

                //Environment bg
                {678, 172 },{679, 173 },{680, 174 },{681, 175 },{682, 176 },

                //Domestic bg
                {683, 177 },{684, 178 },{685, 179 },{686, 180 },{687, 181 },
                {807,289 },

                //Halloween 2015 bg
                {694, 188 },{695, 189 },{696, 190 },

                //Artic bg
                {702, 196 },{703, 197 },

                //Fairytale
                {704, 201 },{705, 202 },{706, 203 },{707, 204 },


                //Summer 2016 bg
                {708, 205 },{712, 206 },{713, 207 },{714, 208 },

                //Mine bg
                {720,219 },

                //Textile bg
                {721, 214 },{722, 215 },{723, 216 },{724, 217 },{725, 218 },

                //Halloween 2016 bg
                {726, 220 },{727, 221 },

                //Construction bg
                {728, 222 },{729, 223 },{730, 224 },{731, 225 },{732, 226 },
                {753, 247 },{754, 248 },{755, 249 },{756, 250 },

                //Tiles bg
                {733, 227 },{734, 228 },{735, 229 },{736, 230 },{737, 231 },
                {738, 232 },{739, 233 },{740, 234 },{741, 235 },{742, 236 },

                //Winter 2018
                {757, 251 },{758, 252 },{759, 253 },{760, 254 },
                ...
                //Magic Bricks bg
                { 778,  260},{ 779,  261},{ 780,  262},{ 781,  263},{ 782,  264},
                { 783,  265},{ 784,  266},{ 785,  267},{ 786,  268},
                {817, 299},
                ...
                //Nature pack
                { 813,295 },{ 814,296 },{815,297 },{816,298 },
            ...
            miscInit = new int[,] {
                ...
                { 1683,589 }, { 1684, 592}, //Purple
                { 1685,594 }, { 1686, 597}, //Orange
                { 1687,599 }, { 1688, 602}, //Cyan
                { 1689,604 }, { 1690, 607}, //Pink
                { 1691,609 }, { 1692, 612}, //Black dark
            ...
            blockInit = new int[,] {
                ...
                //Basic
                {1088, 260},{182,156},{9,9},{10,10},{11,11},{12,12},
                {13,13},{14,14},{15,15},{1018,205},

                //Beta
                {1089, 261},{37,37},{38,38},{39,39},{40,40},{41,41},
                {42,42},{1019,206},{1020,207},{1021,208},

                //Brick
                {1090, 262},{16,16},{17,17},{18,18},{19,19},{20,20},
                {21,21},{1022,209},{1023,210},{1024,211},
                ...
                //Generic
                {22,22},{1057,235},{32,32},{1058,236},{33,33},
                ...
                //Glass
                {1189, 343 },{1190, 344 },{1191, 345 },{51,51},{52,52},{53,53},{54,54},{55,55},
                {56, 56},{57,57},{58,58 },

                //Minerals
                {1186, 346 },{1187, 347 },{1188, 348 },{70,70},{71,71},{72,72},{73,73},{74,74},{75,75},
                {76,76},
                ...
                //Actions
                {0,0 },{1,1 },{2,2 },{3,3 },{4,4 },{1518,285 },{459,233 },


                //Candy
                {60,60},{1154,310},{61,61},{62,62},{63,63},{64,64},
                {65,65},{66,66},{67,67},
                ...
                //Sci-Fi
                {84,84},{85,85},{1150,308},{1151,309},{1162,317},{1163,318},
                {86,86},{87,87},{88,88},{89,89},{90,90},{91,91},{1051,234},
                {1164,319},{1165,320},
                ...
                //Stone
                {95,95},{1044,226},{1045,227},{1046,228},

                //Dojo
                {96,96 },{97,97},

                //Wild West
                {122,99},{123,100},{124,101 },{125,102},{126,103},{127,104},
        ...
        protected void SetupBricks(bool fromclient)
        {
            ...
            //Halloween trophy
            if (ihavethese.ContainsKey("brickhwtrophy")) { AddToolStrip(decosBMD, 2, new int[] { 6 }, null, false, "Prizes", 2, 0, true); } else { AddToolStrip(decosBMD, 2, new int[] { 6 }, null, false, "Prizes", 2, 0, false); }

            if (ihavethese.ContainsKey("brickspringtrophybronze")) { AddToolStrip(decosBMD, 2, new int[] { 209 }, null, false, "Prizes", 2, 0, true); } else { AddToolStrip(decosBMD, 2, new int[] { 209 }, null, false, "Prizes", 2, 0, false); }
            if (ihavethese.ContainsKey("brickspringtrophysilver")) { AddToolStrip(decosBMD, 2, new int[] { 208 }, null, false, "Prizes", 2, 0, true); } else { AddToolStrip(decosBMD, 2, new int[] { 208 }, null, false, "Prizes", 2, 0, false); }
            if (ihavethese.ContainsKey("brickspringtrophygold")) { AddToolStrip(decosBMD, 2, new int[] { 207 }, null, false, "Prizes", 2, 0, true); } else { AddToolStrip(decosBMD, 2, new int[] { 207 }, null, false, "Prizes", 2, 0, false); }
            if (ihavethese.ContainsKey("bricksummertrophybronze")) { AddToolStrip(decosBMD, 2, new int[] { 212 }, null, false, "Prizes", 2, 0, true); } else { AddToolStrip(decosBMD, 2, new int[] { 212 }, null, false, "Prizes", 2, 0, false); }
            if (ihavethese.ContainsKey("bricksummertrophysilver")) { AddToolStrip(decosBMD, 2, new int[] { 211 }, null, false, "Prizes", 2, 0, true); } else { AddToolStrip(decosBMD, 2, new int[] { 211 }, null, false, "Prizes", 2, 0, false); }
            if (ihavethese.ContainsKey("bricksummertrophygold")) { AddToolStrip(decosBMD, 2, new int[] { 210 }, null, false, "Prizes", 2, 0, true); } else { AddToolStrip(decosBMD, 2, new int[] { 210 }, null, false, "Prizes", 2, 0, false); }
            if (ihavethese.ContainsKey("brickdesigntrophybronze")) { AddToolStrip(decosBMD, 2, new int[] { 249 }, null, false, "Prizes", 2, 0, true); } else { AddToolStrip(decosBMD, 2, new int[] { 249 }, null, false, "Prizes", 2, 0, false); }
            if (ihavethese.ContainsKey("brickdesigntrophysilver")) { AddToolStrip(decosBMD, 2, new int[] { 248 }, null, false, "Prizes", 2, 0, true); } else { AddToolStrip(decosBMD, 2, new int[] { 248 }, null, false, "Prizes", 2, 0, false); }
            if (ihavethese.ContainsKey("brickdesigntrophygold")) { AddToolStrip(decosBMD, 2, new int[] { 247 }, null, false, "Prizes", 2, 0, true); } else { AddToolStrip(decosBMD, 2, new int[] { 247 }, null, false, "Prizes", 2, 0, false); }
            ...
            if (ihavethese.ContainsKey("brickspikepurple")) { AddToolStrip(miscBMD, 1, new int[] { 589, 592 }, null, false, "Spikes", 1, 2, true); } else { AddToolStrip(miscBMD, 1, new int[] { 589, 592 }, null, false, "Spikes", 1, 2, false); }
            if (ihavethese.ContainsKey("brickspikeorange")) { AddToolStrip(miscBMD, 1, new int[] { 594, 597 }, null, false, "Spikes", 1, 2, true); } else { AddToolStrip(miscBMD, 1, new int[] { 594, 597 }, null, false, "Spikes", 1, 2, false); }
            if (ihavethese.ContainsKey("brickspikecyan")) { AddToolStrip(miscBMD, 1, new int[] { 599, 602 }, null, false, "Spikes", 1, 2, true); } else { AddToolStrip(miscBMD, 1, new int[] { 599, 602 }, null, false, "Spikes", 1, 2, false); }
            if (ihavethese.ContainsKey("brickspikepink")) { AddToolStrip(miscBMD, 1, new int[] { 604, 607 }, null, false, "Spikes", 1, 2, true); } else { AddToolStrip(miscBMD, 1, new int[] { 604, 607 }, null, false, "Spikes", 1, 2, false); }
            if (ihavethese.ContainsKey("brickspikeblack1")) { AddToolStrip(miscBMD, 1, new int[] { 609, 612 }, null, false, "Spikes", 1, 2, true); } else { AddToolStrip(miscBMD, 1, new int[] { 609, 612 }, null, false, "Spikes", 1, 2, false); }

            //Text block action
            if (accs[selectedAcc].admin) { AddToolStrip(decosBMD, 2, new int[] { 176 }, null, false, "Label", 1, 0, true); } else { AddToolStrip(decosBMD, 2, new int[] { 176 }, null, false, "Label", 1, 0, false); }
            ...
            if (MainForm.userdata.username != "guest" && ihavethese.Any(x => x.Key.StartsWith("npc")) || debug || accs[selectedAcc].admin) AddToolStrip(miscBMD, 1, new int[] { 433 }, null, false, "NPC", 1, 2, true);
            ...
            //Domestic background
            AddToolStrip(backgroundBMD, 3, new int[] { 177, 178, 179, 180, 181, 289 }, new uint[] { 0x624616, 0x371A0D, 0x4A0C07, 0x11304E, 0x063F14, 0x39133D }, false, "Domestic", 3, 2, true);
            ...
            if (ihavethese.ContainsKey("goldmember")) { AddToolStrip(backgroundBMD, 3, new int[] { 198, 199, 200 }, new uint[] { 0x82600E, 0x825707, 0x7E5C10 }, false, "Gold Membership", 3, 2, true); } else { AddToolStrip(backgroundBMD, 3, new int[] { 198, 199, 200 }, new uint[] { 0x82600E, 0x825707, 0x7E5C10 }, false, "Gold Membership", 3, 2, false); }
            ...
            //Magic orange background
            if (ihavethese.ContainsKey("brickmagic10")) { AddToolStrip(backgroundBMD, 3, new int[] { 299 }, new uint[] { 0x430F04 }, false, "Magic", 3, 2, true); } else { AddToolStrip(backgroundBMD, 3, new int[] { 299 }, new uint[] { 0x430F04 }, false, "Magic", 3, 2, false); }
            ...
            if (ihavethese.ContainsKey("bricknature")) { 
                AddToolStrip(backgroundBMD, 3, new int[] { 295,296,297,298 }, new uint[] { 0x291E12, 0x271D11, 0x1F2106, 0x1D2701 }, false, "Nature", 3, 2, true); 
            } else { 
                AddToolStrip(backgroundBMD, 3, new int[] { 295, 296, 297, 298 }, new uint[] { 0x291E12, 0x271D11, 0x1F2106, 0x1D2701 }, false, "Nature", 3, 2, false); 
            }
            #endregion Background
